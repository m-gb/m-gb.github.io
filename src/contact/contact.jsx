  ...
  render() {
    return (
      <div id="contact" data-aos="fade-up" className="text-center">
        <h1 className="font-weight-bold"><i className="fas fa-envelope pr-3" />Contact</h1>
        <div className="contact-icons">
          <h5 className="p-5">For more information, you can visit my <a href="https://github.com/m-gb">GitHub</a> and <a href="https://il.linkedin.com/in/maya-goldberg-528689150?trk=people-guest_profile-result-card_result-card_full-click">LinkedIn</a> profiles.</h5>
